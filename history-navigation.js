(()=>{
  ...
  function rebuildNav(){
    ...
    let current=[...nav.querySelectorAll('button')].find(b=>['current picks','week 3','current games','weekly picks','games roster'].includes(b.textContent.trim().toLowerCase()));if(current){current.textContent='Games Roster';current.onclick=()=>show('picks');}
